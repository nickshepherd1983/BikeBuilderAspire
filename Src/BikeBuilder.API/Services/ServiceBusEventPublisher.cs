...
// Copied verbatim into BikeBuilder.API.Orders and BikeBuilder.API.Ratings (Contracts stays free
// of Azure package references) - change all three together. PascalCase payload (default
// JsonSerializer options) and the MessageType application property the consumers switch on.
